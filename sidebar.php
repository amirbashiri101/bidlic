<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse slimscrollsidebar">
				<ul class="nav" id="side-menu">
					...
					<li class="user-pro">
						<a href="#" class="waves-effect"><img src="themes/assets/images/users/varun.jpg" alt="user-img" class="img-circle"> <span class="hide-menu"> استیو جابز<span class="fa arrow"></span></span>
						</a>
					...
					<li><a href="inbox.html" class="waves-effect active"><i class="zmdi zmdi-apps zmdi-hc-fw fa-fw"></i> <span class="hide-menu">اپ ها <span class="fa arrow"></span></span></a>
						<ul class="nav nav-second-level">
					...
					<li> <a href="#" class="waves-effect"><i class="zmdi zmdi-format-color-fill zmdi-hc-fw fa-fw"></i> <span class="hide-menu">رابط کاربری<span class="fa arrow"></span> <span class="label label-rouded label-info pull-left">13</span> </span></a>
						<ul class="nav nav-second-level">
							...
							<li><a href="sweetalert.html">لورم ایپسوم</a></li>
					...
					<li> <a href="forms.html" class="waves-effect"><i class="zmdi zmdi-comment-alt-text zmdi-hc-fw fa-fw"></i> <span class="hide-menu">فرم ها<span class="fa arrow"></span></span></a>
						<ul class="nav nav-second-level">
